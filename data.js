...
const PROJECTS = [{
  ...
  summary: "Data Engineering Zoomcamp 2026 capstone: daily Notice of Default filings from 6 Southern California counties land in a GCS data lake, load into partitioned BigQuery tables, get modeled with dbt, and surface in a Looker Studio dashboard. Infrastructure in Terraform; runs every weekday.",
  tags: ["GCP", "BigQuery", "dbt", "Terraform", "Kestra", "Python"],
  domains: ["ml", "cloud"],
  links: [{
    label: "GitHub",
    href: "https://github.com/HighviewOne/SoCal-NOD-Tracker"
  }, {
    label: "Zoomcamp coursework",
    href: "https://github.com/HighviewOne/DataEngineeringZoomcamp2026"
  }]
}, {
  id: "ml-registry",
  ...
  links: [{
    label: "GitHub",
    href: "https://github.com/HighviewOne/ml-model-registry"
  }]
}, {
  id: "ml-pipelines",
  title: "ML Model Deployment: Docker, Serverless, Kubernetes",
  summary: "ML Zoomcamp 2025 coursework and midterm project: models served via FastAPI/Flask in Docker, serverless inference on AWS Lambda, and TensorFlow Serving on Kubernetes.",
  tags: ["Docker", "Kubernetes", "MLOps"],
  domains: ["ml", "cloud"],
  links: [{
    label: "Coursework",
    href: "https://github.com/HighviewOne/machine-learning-zoomcamp-homework"
  }, {
    label: "Wine quality project",
    href: "https://github.com/HighviewOne/MLZoomcampProject1"
  }]
}, {
  ...
  links: [{
    ...
    href: "https://github.com/HighviewOne/flower-classification-capstone"
  }, {
    label: "Activity recognition",
    href: "https://github.com/HighviewOne/har-classification-capstone"
  }]
}, {
  id: "realtime",
  title: "Collaborative Coding Interview Platform",
  summary: "Shareable interview sessions with a Monaco code editor synced live across participants over WebSockets, plus in-browser JavaScript and Python (Pyodide/WASM) execution.",
  tags: ["WebSocket", "React", "Express", "WASM"],
  domains: ["cloud"],
  links: [{
    label: "GitHub",
    href: "https://github.com/HighviewOne/CodingInterviewPlatform"
  }]
}, {
  id: "solar",
